...
class InvitationsService @Inject() (
  ...
  def createInvitation(arn: Arn, invitation: Invitation)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext,
  ...
  def createMultipleInvitations(arn: Arn, requests: Set[AuthorisationRequest])(implicit
    rh: RequestHeader,
    ec: ExecutionContext
  ...
  private def respondToInvitation(invitationId: InvitationId, si: StoredInvitation, agentName: String, isAccepted: Boolean)(implicit
    request: Request[_],
    hc: HeaderCarrier,
    ec: ExecutionContext
  ) =
  ...
  def respondToInvitation(invitationId: InvitationId, agentName: String, isAccepted: Boolean)(implicit
    request: Request[_],
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[Boolean] =
  ...
  def createInvitationSent(agencyEmail: String, invitationLink: String, arn: Arn, basket: Set[AuthorisationRequest])(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[State] = {
