...
class PersonalDetailsValidationConnector @Inject()(
  ...
  def getPdvResult(validationId: String)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[Nino]] =
      ...
      http
        ...
        .recover {
          case e: NotFoundException => {
            Logger.warn(s"personal details validation did not recognise the valildation is $validationId $e")
            None
          }
        }
    }
