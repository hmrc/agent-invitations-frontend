...
import uk.gov.hmrc.agentinvitationsfrontend.models.BusinessInvitationsBasket

case class ReviewAuthorisationsBusinessPageConfig(
  ...
  val basketFull: Boolean =
    new BusinessInvitationsBasket(services, basket, featureFlags).availableServices.isEmpty
