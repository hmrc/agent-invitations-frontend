...
class AfiClientRelationshipControllerISpec extends BaseISpec {

  lazy val controller: AfiClientRelationshipController = app.injector.instanceOf[AfiClientRelationshipController]
