  ...
  "RedirectUrlActions" should {
    ...
    "getRedirectUrl" should {
      "successfully extract a valid continue url" in {
        ...
        val result: Option[RedirectUrl] = redirectUrlActions.getRedirectUrl
      ...
      "throw a bad request exception when the continue url is invalid" in {
        ...
        intercept[BadRequestException] {
          redirectUrlActions.getRedirectUrl
        }
      }
    ...
    "getErrorUrl" should {
      "successfully extract a valid error url" in {
        ...
        val result: Option[RedirectUrl] = redirectUrlActions.getErrorUrl
      ...
      "throw a BadRequest exception when the error url is invalid" in {
        ...
        intercept[BadRequestException] {
          redirectUrlActions.getErrorUrl
        }
      }
    ...
    "maybeRedirectUrlOrBadRequest" should {
      "carry out the function block when the continue url has a allowlisted domain" in {
      ...
      "carry out the function block when there is no continue url" in {
        ...
        val result =
          redirectUrlActions.maybeRedirectUrlOrBadRequest(None)(_ => Future(Ok("success")))
        status(result) shouldBe 200
      }
    }
  }
