...
trait ACAStubs {
  ...
  def givenAgentReference(arn: Arn, uid: String, clientType: ClientType): Any =
    stubFor(
      post(urlEqualTo(s"/agent-client-authorisation/agencies/references/arn/${encodePathSegment(arn.value)}/clientType/$clientType"))
        .willReturn(
          aResponse()
            .withStatus(201)
      ...
      post(urlEqualTo(s"/agent-client-authorisation/agencies/${encodePathSegment(arn.value)}/invitations/sent"))
        ...
        .willReturn(
          aResponse()
            ...
            .withHeader(
              "location",
              s"$wireMockBaseUrlAsString/agent-client-authorisation/clients/$serviceIdentifier/${encodePathSegment(clientId)}/invitations/received/${invitationId.value}"
            )
        )
    )
  ...
  def givenInvitationByIdSuccess(
    invitationId: InvitationId,
    clientId: String,
    service: Service = Service.MtdIt,
    clientIdType: String = "mtditid",
    suppliedClientId: Option[String] = None,
    suppliedClientIdType: Option[String] = None
  ): StubMapping =
    stubFor(
  ...
  def givenInvitationExpired(arn: Arn, clientId: String, invitationId: InvitationId, service: Service, serviceIdentifier: String): StubMapping =
    stubFor(
      get(
        urlEqualTo(
          s"/agent-client-authorisation/clients/$serviceIdentifier/${encodePathSegment(clientId)}/invitations/received/${invitationId.value}"
  ...
  def givenInvitationCancelled(arn: Arn, clientId: String, invitationId: InvitationId, service: Service, serviceIdentifier: String): StubMapping =
    stubFor(
      get(
        urlEqualTo(
          s"/agent-client-authorisation/clients/$serviceIdentifier/${encodePathSegment(clientId)}/invitations/received/${invitationId.value}"
  ...
  def givenInvitationAccepted(arn: Arn, clientId: String, invitationId: InvitationId, service: Service, serviceIdentifier: String) =
    stubFor(
      get(
        urlEqualTo(
          s"/agent-client-authorisation/clients/$serviceIdentifier/${encodePathSegment(clientId)}/invitations/received/${invitationId.value}"
  ...
  def givenAcceptInvitationReturnsNotFound(clientId: String, invitationId: InvitationId, serviceIdentifier: String) =
    acceptInvitationStub(clientId, invitationId, responseStatus = 404, serviceIdentifier)

  private def acceptInvitationStub(clientId: String, invitationId: InvitationId, responseStatus: Int, serviceIdentifier: String) = {
  ...
  def givenGetInvitationReturnsAlreadyActioned(clientId: String, invitationId: InvitationId, serviceIdentifier: String) =
    stubFor(
      get(
        urlEqualTo(
          s"/agent-client-authorisation/clients/$serviceIdentifier/${encodePathSegment(clientId)}/invitations/received/${invitationId.value}"
  ...
  def givenAcceptInvitationReturnsAlreadyActioned(clientId: String, invitationId: InvitationId, serviceIdentifier: String) = {
    val identifierEncoded = encodePathSegment(clientId)
    val invitationIdEncoded = encodePathSegment(invitationId.value)
    stubFor(
      put(urlEqualTo(s"/agent-client-authorisation/clients/$serviceIdentifier/$identifierEncoded/invitations/received/$invitationIdEncoded/accept"))
        .willReturn(
          aResponse()
            .withStatus(403)
            .withBody(
  ...
  def givenGetInvitationReturnsNoPermission(clientId: String, invitationId: InvitationId, serviceIdentifier: String) =
    stubFor(
      get(
        urlEqualTo(
          s"/agent-client-authorisation/clients/$serviceIdentifier/${encodePathSegment(clientId)}/invitations/received/${invitationId.value}"
  ...
  def givenAcceptInvitationReturnsNoPermission(clientId: String, invitationId: InvitationId, serviceIdentifier: String) = {
    val identifierEncoded = encodePathSegment(clientId)
    val invitationIdEncoded = encodePathSegment(invitationId.value)
    stubFor(
      put(urlEqualTo(s"/agent-client-authorisation/clients/$serviceIdentifier/$identifierEncoded/invitations/received/$invitationIdEncoded/accept"))
  ...
  def verifyAcceptInvitationAttempt(clientId: String, invitationId: InvitationId, serviceIdentifier: String) = {
    ...
    verify(
      1,
      putRequestedFor(
        urlEqualTo(s"/agent-client-authorisation/clients/$serviceIdentifier/$identifierEncoded/invitations/received/$invitationIdEncoded/accept")
      )
    )
  }
  ...
  def givenRejectInvitationReturnsWithStatus(clientId: String, invitationId: InvitationId, serviceIdentifier: String, status: Int = 404) =
    rejectInvitationStub(clientId, invitationId, responseStatus = status, serviceIdentifier)

  private def rejectInvitationStub(clientId: String, invitationId: InvitationId, responseStatus: Int, serviceIdentifier: String) = {
    val identifierEncoded = encodePathSegment(clientId)
    val invitationIdEncoded = encodePathSegment(invitationId.value)
    stubFor(
      put(urlEqualTo(s"/agent-client-authorisation/clients/$serviceIdentifier/$identifierEncoded/invitations/received/$invitationIdEncoded/reject"))
        .willReturn(
          aResponse()
            .withStatus(responseStatus)
        )
  ...
  def givenRejectInvitationReturnsAlreadyActioned(clientId: String, invitationId: InvitationId, serviceIdentifier: String) = {
    val identifierEncoded = encodePathSegment(clientId)
    val invitationIdEncoded = encodePathSegment(invitationId.value)
    stubFor(
      put(urlEqualTo(s"/agent-client-authorisation/clients/$serviceIdentifier/$identifierEncoded/invitations/received/$invitationIdEncoded/reject"))
  ...
  def verifyRejectInvitationAttempt(clientId: String, invitationId: InvitationId, serviceIdentifier: String) = {
    ...
    verify(
      1,
      putRequestedFor(
        urlEqualTo(s"/agent-client-authorisation/clients/$serviceIdentifier/$identifierEncoded/invitations/received/$invitationIdEncoded/reject")
      )
    )
  }
  ...
  def givenVatRegisteredClientReturns(vrn: Vrn, date: LocalDate, responseStatus: Int, clientInsolvent: Boolean = false) = {
    val bodyMsg = if (responseStatus == 403) {
      if (clientInsolvent) """VAT_RECORD_CLIENT_INSOLVENT_TRUE""" else s"""VAT_REGISTRATION_DATE_DOES_NOT_MATCH"""
    } else """"""
    stubFor(
      get(urlEqualTo(s"/agent-client-authorisation/known-facts/organisations/vat/${vrn.value}/registration-date/${date.toString}"))
        .willReturn(
          aResponse()
            .withStatus(responseStatus)
            .withBody(bodyMsg)
  ...
  def givenTrustClientReturns(taxIdentifier: TrustTaxIdentifier, responseStatus: Int, body: String) =
    stubFor(
      get(urlEqualTo(s"/agent-client-authorisation/known-facts/organisations/trust/${taxIdentifier.value}"))
        .willReturn(
          aResponse()
            .withStatus(responseStatus)
            .withBody(body)
  ...
  def givenGetCgtSubscriptionReturns(cgtRef: CgtRef, responseStatus: Int, body: String) =
    stubFor(
      get(urlEqualTo(s"/agent-client-authorisation/cgt/subscriptions/${cgtRef.value}"))
        .willReturn(
          aResponse()
            .withStatus(responseStatus)
            .withBody(body)
  ...
  def givenGetPptSubscriptionReturns(pptRef: PptRef, responseStatus: Int, body: String) =
    stubFor(
      get(urlEqualTo(s"/agent-client-authorisation/ppt/subscriptions/${pptRef.value}"))
        .willReturn(
          aResponse()
            .withStatus(responseStatus)
            .withBody(body)
  ...
  def verifyCheckVatRegisteredClientStubAttempt(vrn: Vrn, date: LocalDate) = {
    ...
    verify(1, getRequestedFor(urlEqualTo(s"/agent-client-authorisation/known-facts/organisations/vat/$vrnEncoded/registration-date/$dateEncoded")))
  }
  ...
  def verifyCheckItsaRegisteredClientStubAttempt(nino: Nino, postcode: String) = {
    ...
    verify(1, getRequestedFor(urlEqualTo(s"/agent-client-authorisation/known-facts/individuals/nino/$ninoEncoded/sa/postcode/$postEncoded")))
  }

  def verifyNoCheckVatRegisteredClientStubAttempt() =
    verify(0, getRequestedFor(urlPathMatching("/agent-client-authorisation/known-facts/organisations/.*/registration-date/.*")))
  ...
  def givenASingleInvitationWithRelationshipEnded(clientId: String, service: Service, clientIdType: String, lastUpdated: LocalDateTime) =
    stubFor(
            ...
            .withBody(
              halEnvelope(
                Seq(
                  invitationTemporal(
                    lastUpdated,
                    if (isPartialAuth) "Partialauth" else "Accepted",
                    service,
                    clientIdType,
                    "Julius",
                    clientId,
  ...
  def givenASingleInvitationWithRelationshipStillActive(clientId: String, service: Service, clientIdType: String, lastUpdated: LocalDateTime) =
    stubFor(
      get(urlPathEqualTo(s"/agent-client-authorisation/agencies/TARN0000001/invitations/sent"))
        .withQueryParam("createdOnOrAfter", equalTo(LocalDate.now.minusDays(30).toString))
        .willReturn(
              ...
              halEnvelope(
                Seq(
                  invitationTemporal(
                    ...
                    clientId,
                    "foo1",
                    lastUpdated.toLocalDate.plusDays(5).toString,
                    false,
                    None
                  )
                ).mkString("[", ",", "]")
      ...
      get(
        ...
        .willReturn(
          aResponse()
            ...
            .withBody(
              halEnvelope(
                Seq(invitation(arn, "Partialauth", Service.MtdIt, "ni", clientId, "foo1", "2017-12-18", false, None)).mkString("[", ",", "]")
              )
            )
        )
    )
  ...
  def givenCbcCheckKnownFactReturns(cbcClient: CbcClient, status: Int) =
    stubFor(
      post(urlEqualTo(s"/agent-client-authorisation/known-facts/cbc/${cbcClient.cbcId.value}"))
        .withRequestBody(equalToJson(s"""{"email":"${cbcClient.email}"}"""))
        .willReturn(
          aResponse()
            .withStatus(status)
        )
  ...
  def givenPillar2CheckKnownFactReturns(pillar2Client: Pillar2Client, status: Int) =
    stubFor(
      post(urlEqualTo(s"/agent-client-authorisation/known-facts/pillar2/${pillar2Client.plrId.value}"))
        .withRequestBody(equalToJson(s"""{"registrationDate":"${pillar2Client.registrationDate}"}"""))
        .willReturn(
          aResponse()
            .withStatus(status)
        )
  ...
  def givenGetPptCustomerName(pptRef: PptRef, name: String) =
    stubFor(
      get(urlEqualTo(s"/agent-client-authorisation/client/ppt-customer-name/pptref/${pptRef.value}"))
        .willReturn(
          aResponse()
            .withBody(s"""{"customerName":"$name"}""".stripMargin)
            .withStatus(200)
        )
    )
