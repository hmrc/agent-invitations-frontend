  ...
  "AgentInvitationJourneyService" when {
    "at state SelectClientType" should {
      ...
      "transition to SelectPersonalService with fewer services when agent is not whitelisted" in {
        given(SelectClientType(emptyBasket)) when selectedClientType(authorisedAgentNotWhitelisted)("personal") should thenGo(
          SelectPersonalService(nonWhitelistedServices, emptyBasket))
      }
      ...
      "transition to IdentifyPersonalClient for PIR service" in {
        await(
          given(SelectPersonalService(availableServices, emptyBasket)) when selectedPersonalService(
            ...
            showPirFlag = true,
            showVatFlag = true,
            showCgtFlag = true)(authorisedAgent)(HMRCPIR)) should thenGo(IdentifyPersonalClient(HMRCPIR, emptyBasket))
      }
    ...
    "at state SelectBusinessService" should {
      ...
      "after selectedBusinessService(true)(true) transition to IdentifyBusinessClient" in {
        given(SelectBusinessService) when selectedBusinessService(showVatFlag = true)(authorisedAgent)(
          Confirmation(true)) should thenGo(IdentifyBusinessClient)
      }
      "after selectedBusinessService(true)(false) transition to SelectClientType" in {
        given(SelectBusinessService) when selectedBusinessService(showVatFlag = true)(authorisedAgent)(
          Confirmation(false)) should thenGo(SelectClientType(emptyBasket))
      }
      "throw an exception when the show vat feature flag is off" in {
        intercept[Exception] {
          given(SelectBusinessService) when selectedBusinessService(showVatFlag = false)(authorisedAgent)(
            Confirmation(true))
        }.getMessage shouldBe "Service: HMRC-MTD-VAT feature flag is switched off"
      }
    }
    ...
    "at state SelectTrustService" should {
      "transition to SelectClientType" in {
        given(SelectTrustService(availableTrustServices, emptyBasket)) when start should thenGo(
          SelectClientType(emptyBasket))
      }
      "after selectedTrustService(true)(true) transition to IdentifyTrustClient" in {
        given(SelectTrustService(availableTrustServices, emptyBasket)) when selectedTrustServiceSingle(showTrustsFlag =
          true)(authorisedAgent)(Confirmation(true)) should thenGo(IdentifyTrustClient(TRUST, emptyBasket))
      }
      "after selectedTrustService(true)(false) transition to SelectClientType" in {
        given(SelectTrustService(availableTrustServices, emptyBasket)) when selectedTrustServiceSingle(
          showTrustsFlag = true)(authorisedAgent)(Confirmation(false)) should thenGo(SelectClientType(emptyBasket))
      }
      "throw an exception when the show vat feature flag is off" in {
        intercept[Exception] {
          given(SelectTrustService(availableTrustServices, emptyBasket)) when selectedTrustServiceSingle(
            showTrustsFlag = false)(authorisedAgent)(Confirmation(true))
    ...
    "at state IdentifyPersonalClient" should {
      ...
      "transition to ConfirmClientItsa" in {
        ...
        given(IdentifyPersonalClient(HMRCMTDIT, emptyBasket)) when identifiedItsaClient(checkPostcodeMatches)(
          ...
          getAgencyEmail)(authorisedAgent)(ItsaClient("AB123456A", "BN114AW")) should matchPattern {
          case (
              ConfirmClientItsa(
      ...
      "transition to KnownFactsNotMatched when the nino and postcode do not match" in {
        ...
        given(IdentifyPersonalClient(HMRCMTDIT, emptyBasket)) when identifiedItsaClient(checkPostcodeMatches)(
          hasNoPendingInvitation)(hasNoActiveRelationship)(clientName)(createMultipleInvitations)(getAgentLink)(
          getAgencyEmail)(authorisedAgent)(ItsaClient("AB123456A", "BN114AW")) should
    ...
    "at state IdentifyBusinessClient" should {
      ...
      "transition to ConfirmClientBusinessVat" in {
        ...
        given(IdentifyBusinessClient) when identifiedVatClient(checkRegDateMatches)(hasNoPendingInvitation)(
          hasNoActiveRelationship)(clientName)(createMultipleInvitations)(getAgentLink)(getAgencyEmail)(
          authorisedAgent)(VatClient("123456", "2010-10-10")) should matchPattern {
          case (
      ...
      "transition to KnownFactNotMatched client" in {
        ...
        given(IdentifyBusinessClient) when identifiedVatClient(checkRegDateMatches)(hasNoPendingInvitation)(
          hasNoActiveRelationship)(clientName)(createMultipleInvitations)(getAgentLink)(getAgencyEmail)(
          authorisedAgent)(VatClient("123456", "2010-10-10")) should
          thenGo(KnownFactNotMatched(emptyBasket))
      }
      ...
      "transition to ActiveRelationshipExists" in {
        ...
        def checkRegDateMatches(vrn: Vrn, regDate: LocalDate) = Future(Some(204))
        given(IdentifyBusinessClient) when identifiedVatClient(checkRegDateMatches)(hasNoPendingInvitation)(
          hasActiveRelationship)(clientName)(createMultipleInvitations)(getAgentLink)(getAgencyEmail)(authorisedAgent)(
    ...
    "at ConfirmClientItsa" should {
      ...
      "transition to ReviewAuthorisationsPersonal" in {
        given(ConfirmClientItsa(authorisationRequest, emptyBasket)) when clientConfirmed(showCgtFlag = false)(
          createMultipleInvitations)(getAgentLink)(getAgencyEmail)(hasNoPendingInvitation)(hasNoActiveRelationship)(
          authorisedAgent)(Confirmation(true)) should
          thenMatch { case ReviewAuthorisationsPersonal(_, basket) if basket.nonEmpty => }
      }
      "transition to SelectPersonalService" in {
        given(ConfirmClientItsa(authorisationRequest, emptyBasket)) when clientConfirmed(showCgtFlag = false)(
          createMultipleInvitations)(getAgentLink)(getAgencyEmail)(hasNoPendingInvitation)(hasNoActiveRelationship)(
      ...
      "transition to PendingInvitationExists when the invitation is already in the basket" in {
        given(ConfirmClientItsa(
          authorisationRequest,
          Set(AuthorisationRequest("client name", Invitation(Some(personal), HMRCMTDIT, "AB123456A", "BN114AW"))))) when clientConfirmed(
          showCgtFlag = false)(createMultipleInvitations)(getAgentLink)(getAgencyEmail)(hasNoPendingInvitation)(
          hasNoActiveRelationship)(authorisedAgent)(Confirmation(true)) should
          thenMatch { case PendingInvitationExists(_, basket) if basket.nonEmpty => }
      }
    }
    ...
    "at ConfirmClientPersonalVat" should {
      ...
      "transition to Start" in {
        given(
          ConfirmClientPersonalVat(
            AuthorisationRequest("Piglet", VatInvitation(Some(personal), Vrn("123456"), VatRegDate("2010-10-10"))),
      ...
      "transition to ClientConfirmedPersonal" in {
        given(
          ConfirmClientPersonalVat(
            AuthorisationRequest("Piglet", VatInvitation(Some(personal), Vrn("123456"), VatRegDate("2010-10-10"))),
            emptyBasket)) when clientConfirmed(showCgtFlag = false)(createMultipleInvitations)(getAgentLink)(
          getAgencyEmail)(hasNoPendingInvitation)(hasNoActiveRelationship)(authorisedAgent)(Confirmation(true)) should
          thenMatch { case ReviewAuthorisationsPersonal(_, basket) if basket.nonEmpty => }
      }
      "transition to PersonalServiceSelected" in {
        given(
          ConfirmClientPersonalVat(
            AuthorisationRequest("Piglet", VatInvitation(Some(personal), Vrn("123456"), VatRegDate("2010-10-10"))),
            emptyBasket)) when clientConfirmed(showCgtFlag = false)(createMultipleInvitations)(getAgentLink)(
          getAgencyEmail)(hasNoPendingInvitation)(hasNoActiveRelationship)(authorisedAgent)(Confirmation(false)) should
    ...
    "at ConfirmClientBusinessVat" should {
      val authorisationRequest =
        AuthorisationRequest("Piglet", VatInvitation(Some(business), Vrn("123456"), VatRegDate("2010-10-10")))
      def createMultipleInvitations(arn: Arn, requests: Set[AuthorisationRequest]): Future[Set[AuthorisationRequest]] =
        Future(emptyBasket)
      def getAgentLink(arn: Arn, clientType: Option[ClientType]) = Future("invitation/link")
      def hasNoPendingInvitation(arn: Arn, clientId: String, service: String): Future[Boolean] =
      ...
      "after clientConfirmed(true) transition to InvitationSentBusiness" in {
        given(ConfirmClientBusinessVat(authorisationRequest)) when clientConfirmed(showCgtFlag = false)(
          createMultipleInvitations)(getAgentLink)(getAgencyEmail)(hasNoPendingInvitation)(hasNoActiveRelationship)(
          authorisedAgent)(Confirmation(true)) should
      ...
      "transition to PendingInvitationExists when there is already a pending invitation" in {
        def hasPendingInvitation(arn: Arn, clientId: String, service: String): Future[Boolean] =
          Future.successful(true)
        given(ConfirmClientBusinessVat(authorisationRequest)) when clientConfirmed(showCgtFlag = false)(
          createMultipleInvitations)(getAgentLink)(getAgencyEmail)(hasPendingInvitation)(hasNoActiveRelationship)(
          authorisedAgent)(Confirmation(true)) should
      ...
      "transition to ActiveAuthorisationEXists when an active relationship already exists" in {
        def hasActiveRelationship(arn: Arn, clientId: String, service: String): Future[Boolean] =
          Future.successful(true)
        given(ConfirmClientBusinessVat(authorisationRequest)) when clientConfirmed(showCgtFlag = false)(
          createMultipleInvitations)(getAgentLink)(getAgencyEmail)(hasNoPendingInvitation)(hasActiveRelationship)(
          authorisedAgent)(Confirmation(true)) should
    ...
    "at ConfirmClientTrust" should {
      ...
      "transition to IdentifyTrustClient if NO is selected" in {
        given(ConfirmClientTrust(authorisationRequest, emptyBasket)) when clientConfirmed(showCgtFlag = false)(
          createMultipleInvitations)(getAgentLink)(getAgencyEmail)(hasNoPendingInvitation)(hasNoActiveRelationship)(
          authorisedAgent)(Confirmation(false)) should thenGo(IdentifyTrustClient(TRUST, emptyBasket))
      }
      ...
      "transition to PendingInvitationExists when a pending invitation exists for the service" in {
        ...
        given(ConfirmClientTrust(authorisationRequest, emptyBasket)) when clientConfirmed(showCgtFlag = false)(
          createMultipleInvitations)(getAgentLink)(getAgencyEmail)(hasPendingInvitation)(hasNoActiveRelationship)(
          authorisedAgent)(Confirmation(true)) should thenGo(PendingInvitationExists(business, emptyBasket))
      }
    ...
    "at ReviewAuthorisationsPersonal" should {
      ...
      "after authorisationsReviewed(true) transition to SelectPersonalService" in {
        ...
        given(ReviewAuthorisationsPersonal(availableServices, emptyBasket)) when authorisationsReviewed(
          createMultipleInvitations)(getAgentLink)(getAgencyEmail)(authorisedAgent)(Confirmation(true)) should
      ...
      "after authorisationsReviewed(false) transition to InvitationSentPersonal" in {
        ...
        given(ReviewAuthorisationsPersonal(availableServices, Set(authorisationRequestNew))) when authorisationsReviewed(
      ...
      "after authorisationsReviewed(false) when some fail transition to AuthorisationReviewedSomeFailed" in {
        ...
        given(
          ReviewAuthorisationsPersonal(availableServices, Set(authorisationRequestNew1, authorisationRequestNew2))
        ) when authorisationsReviewed(createMultipleInvitations)(getAgentLink)(getAgencyEmail)(authorisedAgent)(
      ...
      "after deleteAuthorisationRequest with a valid itemId transition to DeleteAuthorisationRequestPersonal" in {
        val authorisationRequest = AuthorisationRequest(
          ...
          AuthorisationRequest.NEW,
          "ABC123")
        given(ReviewAuthorisationsPersonal(availableServices, Set(authorisationRequest))) when deleteAuthorisationRequest(
          "ABC123")(authorisedAgent) should thenGo(
    ...
    "at DeleteAuthorisationRequestPersonal" should {
      ...
      "after confirmDeleteAuthorisationRequest(true) should transition to ReviewAuthorisationPersonal with one request removed form the basket" in {
        ...
        given(DeleteAuthorisationRequestPersonal(
          ...
          thenGo(ReviewAuthorisationsPersonal(availableServices, Set(authorisationRequest2)))
      }
      ...
      "after confirmDeleteAuthorisationRequest(false) should transition to ReviewAuthorisationPersonal with basket in tact" in {
        ...
        given(DeleteAuthorisationRequestPersonal(authorisationRequest, Set(authorisationRequest))) when confirmDeleteAuthorisationRequest(
          authorisedAgent)(Confirmation(false)) should
          thenGo(ReviewAuthorisationsPersonal(availableServices, Set(authorisationRequest)))
      }
    }
    "at state SomeAuthorisationFailed" should {
      "go to InvitationSentPersonal state" in {
        given(SomeAuthorisationsFailed("invitation/link", None, "abc@xyz.com", Set.empty)) when continueSomeResponsesFailed(
