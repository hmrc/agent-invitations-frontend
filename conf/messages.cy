...
warm-up.p2.trust=Er mwyn i ni allu cadarnhau pwy ydych, bydd yn rhaid i chi fewngofnodi gan ddefnyddio’r Dynodydd Defnyddiwr (ID) a’r cyfrinair ar gyfer Porth y Llywodraeth yr ydych yn eu defnyddio ar gyfer eich <strong class = "bold">materion treth busnes</strong>.
...
confirm-terms-multi.vat.list.item5=eich cofrestru ar gyfer y cynllun Troi Treth yn Ddigidol ar gyfer TAW neu eich optio allan ohono
confirm-terms-multi.vat.list.item6=rheoli’ch TAW drwy ddefnyddio meddalwedd
confirm-terms-multi.vat.list.item7=canslo’ch cofrestriad TAW
